...
class SimpleDisplay extends SimDisplay
{
	...
	*/
	public Shape getShape(SimObject o)
	{
		...
		else if (o.getType().equalsIgnoreCase("path"))
		{
			//SimObject is a path
			s=createPathShape(o.getXCoord(),o.getZCoord(),o.getWidth(),o.getLength());
		}
		else
		{
	...
	*/
	...
	/**
	* Creates a path shape of the appropriate dimension
	*/
	private Shape createPathShape(double x, double z, double width, double length)
	{
		// establish top left corner of object
		double X=(x-(width/2));
		double Z=(z-(length/2));
