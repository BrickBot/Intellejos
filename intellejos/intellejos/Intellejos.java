...
public class Intellejos
{
	...
	*/
	...
	{
		System.out.println(	"\nUsage: java Intellejos [-option]\n"+
							"\nwhere option is one of:\n\n"+
							"\t-d -debug\truns Intellejos in debug mode (prints messages to stdout)\n"+
	...
	*/
	public static void main(String args[])
	{
		...
		addToLog("Intellejos.main(): GUI set up successfully");
	}
}
